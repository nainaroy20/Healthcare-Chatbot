...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblMsg.pack()
        self.btnLogin=Button(self, text="Login", height="4", width="600", command = self.lblLogin_Click)
        self.btnLogin.pack()
        self.btnRegister=Button(self, text="Register", height="4", width="600", command = self.btnRegister_Click)
        self.btnRegister.pack()
        self.lblTeam=Label(self, text="𝑀𝑎𝑑𝑒 𝑏𝑦:", bg="slateblue", width = "650", height = "2", font=("Futura", 20))
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Naina Roy", bg="RoyalBlue2", width = "650", height = "2", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Khushi Upadhaya", bg="RoyalBlue3", width = "650", height = "2", font=("Calibri", 13))
        self.lblTeam2.pack()
