...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="𝑯𝒆𝒂𝒍𝒕𝒉 𝑪𝒂𝒓𝒆 𝑪𝒉𝒂𝒕𝒃𝒐𝒕", bg="PeachPuff2", width="600", height="8", font=("Futura", 40))
        self.lblMsg.pack()
        self.btnLogin=Button(self, text="Login", height="4", width="600", font=("Futura", 12), fg="black", command = self.lblLogin_Click)
        self.btnLogin.pack()
        self.btnRegister=Button(self, text="Register", height="4", width="600", font=("Futura", 12), fg="black", command = self.btnRegister_Click)
        self.btnRegister.pack()
        self.lblTeam=Label(self, text="𝑀𝑎𝑑𝑒 𝑏𝑦:", bg="black", width = "600", height = "2", font=("Futura", 15), fg="white" )
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Naina Roy", bg="black", width = "600", height = "2", font=("Futura", 13), fg="white" )
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Khushi Upadhyay", bg="black", width = "600", height = "2", font=("Futura", 13), fg="white" )
        self.lblTeam2.pack()
...
class Login(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg = Label(self, text="𝑷𝒍𝒆𝒂𝒔𝒆 𝒆𝒏𝒕𝒆𝒓 𝒅𝒆𝒕𝒂𝒊𝒍𝒔 𝒃𝒆𝒍𝒐𝒘 𝒕𝒐 𝒍𝒐𝒈𝒊𝒏 :", bg="Light blue", font=("Helvetica", 30))
        self.lblMsg.pack()
        self.username = Label(self, text="Username *", font=("Helvetica", 20))
        self.username.pack()
        self.username_verify = StringVar()
        self.username_login_entry = Entry(self, textvariable=self.username_verify)
        self.username_login_entry.pack()
        self.password = Label(self, text="Password *", font=("Helvetica", 20))
        self.password.pack()
        self.password_verify = StringVar()
        self.password_login_entry = Entry(self, textvariable=self.password_verify, show='*')
        self.password_login_entry.pack()
        self.btnLogin = Button(self, text="Login", width=20, height=1, command=self.btnLogin_Click, font=("Arial", 20))
        self.btnLogin.pack()
